/**
 * TC-PROF-01: CEO profile page displays correct info
 * Purpose: Verify CEO profile shows correct name/role/phone
 */
...
export default {
  id: 'TC-PROF-01',
  title: 'CEO profile page displays correct info',
  module: 'profile',
  priority: 'P0',
  tags: ['smoke'],
  credentials: {
  ...
  steps: [
    ...
    { id: 8, desc: 'Assert name visible', action: 'assert', check: { type: 'text_visible', value: 'ceo' } },
    { id: 9, desc: 'Assert role visible', action: 'assert', check: { type: 'text_visible', value: 'CEO' } },
  ],
  expect: {
    result: 'pass',
    url: '/me',
