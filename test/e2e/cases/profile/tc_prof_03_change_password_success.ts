 ...
 * Purpose: Verify password change works and new password can be used to login
 */
...
export default {
  ...
  steps: [
    ...
    { id: 13, desc: 'Fill username', action: 'fill', locator: { by: 'label', value: '用户名' }, value: 'ceo.demo' },
    { id: 14, desc: 'Fill new password', action: 'fill', locator: { by: 'label', value: '密码' }, value: 'NewPass@2026' },
    { id: 15, desc: 'Click login button', action: 'click', locator: { by: 'role', role: 'button', name: '登录' } },
    { id: 16, desc: 'Assert login success', action: 'assert', check: { type: 'url_contains', value: '/dashboard' } },
  ],
  expect: {
    result: 'pass',
    url: '/dashboard',
