/**
 * TC-ORG-15: Create employee without department shows error
 * Purpose: Verify department is required field for employee creation
 */
...
export default {
  id: 'TC-ORG-15',
  title: 'Create employee without department shows error',
  module: 'org',
  priority: 'P1',
  credentials: {
    username: 'hr.demo',
  ...
  steps: [
    ...
    { id: 8, desc: 'Fill phone', action: 'fill', locator: { by: 'label', value: '手机号' }, value: '18800004444' },
    { id: 9, desc: 'Click save button', action: 'click', locator: { by: 'role', role: 'button', name: '保存' } },
    { id: 10, desc: 'Assert department required error', action: 'assert', check: { type: 'text_visible', value: '部门' } },
  ],
  expect: {
    result: 'pass',
    url: '/employees',
