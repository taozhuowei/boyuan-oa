/**
 * TC-ORG-14: Duplicate phone shows error
 * Purpose: Verify duplicate phone number returns 409 conflict
 */
...
export default {
  id: 'TC-ORG-14',
  title: 'Duplicate phone shows error',
  module: 'org',
  priority: 'P1',
  credentials: {
    username: 'hr.demo',
  ...
  steps: [
    ...
    { id: 7, desc: 'Fill employee name', action: 'fill', locator: { by: 'label', value: '姓名' }, value: '测试员工02' },
    { id: 8, desc: 'Fill duplicate phone', action: 'fill', locator: { by: 'label', value: '手机号' }, value: '18800001111' },
    { id: 9, desc: 'Click save button', action: 'click', locator: { by: 'role', role: 'button', name: '保存' } },
    { id: 10, desc: 'Assert duplicate error', action: 'assert', check: { type: 'text_visible', value: '已存在' } },
  ],
  expect: {
    result: 'pass',
    url: '/employees',
