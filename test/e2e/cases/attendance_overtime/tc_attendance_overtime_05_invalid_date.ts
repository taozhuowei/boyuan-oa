...
const tc: TestCase = {
  ...
  steps: [
    ...
    { id: 11, desc: '输入开始时间', action: 'fill', locator: { by: 'placeholder', value: '开始时间' }, value: '2026-04-15 21:00' },
    { id: 12, desc: '输入结束时间（早于开始）', action: 'fill', locator: { by: 'placeholder', value: '结束时间' }, value: '2026-04-15 18:00' },
    { id: 13, desc: '点击提交按钮', action: 'click', locator: { by: 'role', role: 'button', name: '提交' } },
    { id: 14, desc: '断言时间校验错误', action: 'assert', check: { type: 'text_visible', value: '结束时间' } },
  ],
  expect: { result: 'pass' },
};
