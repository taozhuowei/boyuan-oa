...
const tc: TestCase = {
  id: 'TC-OT-01',
  title: '员工提交加班申报（通知直系领导），状态直接 APPROVED',
  ...
  steps: [
    ...
    { id: 11, desc: '输入开始时间', action: 'fill', locator: { by: 'placeholder', value: '开始时间' }, value: '2026-04-15 18:00' },
    { id: 12, desc: '输入结束时间', action: 'fill', locator: { by: 'placeholder', value: '结束时间' }, value: '2026-04-15 21:00' },
    ...
    { id: 15, desc: '断言状态为已通过', action: 'assert', check: { type: 'text_visible', value: '已通过' } },
  ],
  expect: { result: 'pass' },
};
