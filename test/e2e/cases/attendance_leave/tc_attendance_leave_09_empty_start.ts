...
const tc: TestCase = {
  ...
  steps: [
    ...
    { id: 11, desc: '输入结束时间', action: 'fill', locator: { by: 'placeholder', value: '结束时间' }, value: '2026-04-15 18:00' },
    { id: 12, desc: '点击提交按钮', action: 'click', locator: { by: 'role', role: 'button', name: '提交' } },
    { id: 13, desc: '断言校验错误提示', action: 'assert', check: { type: 'text_visible', value: '必填' } },
  ],
  expect: { result: 'pass' },
};
