...
const tc: TestCase = {
  ...
  steps: [
    ...
    { id: 8, desc: '断言存在请假审批项', action: 'assert', check: { type: 'text_visible', value: '请假' } },
    { id: 9, desc: '断言存在待审批', action: 'assert', check: { type: 'text_visible', value: '待审批' } },
  ],
  expect: { result: 'pass' },
};
