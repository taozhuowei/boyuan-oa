/**
 * TC-AUTH-03: Finance correct login
 * Purpose: Verify Finance can login successfully with valid credentials
 */
...
export default {
  ...
  steps: [
    ...
    { id: 6, desc: 'Assert username visible', action: 'assert', check: { type: 'text_visible', value: 'finance.demo' } },
  ],
  expect: {
    result: 'pass',
    url: '/dashboard',
