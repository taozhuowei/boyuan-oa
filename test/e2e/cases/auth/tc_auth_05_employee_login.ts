/**
 * TC-AUTH-05: Employee correct login
 * Purpose: Verify Employee can login successfully with valid credentials
 */
...
export default {
  ...
  steps: [
    ...
    { id: 6, desc: 'Assert username visible', action: 'assert', check: { type: 'text_visible', value: 'employee.demo' } },
  ],
  expect: {
    result: 'pass',
    url: '/dashboard',
