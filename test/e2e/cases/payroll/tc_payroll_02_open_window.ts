...
const tc: TestCase = {
  ...
  steps: [
    ...
    { id: 8, desc: '点击开窗按钮', action: 'click', locator: { by: 'role', role: 'button', name: '开窗' } },
    { id: 9, desc: '断言开窗成功提示', action: 'assert', check: { type: 'toast_contains', value: '成功' } },
    { id: 10, desc: '断言状态变为窗口开启', action: 'assert', check: { type: 'text_visible', value: '窗口开启' } },
  ],
  expect: { result: 'pass' },
};
