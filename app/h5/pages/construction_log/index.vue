  ...
  <div class="construction-log-page">
    ...
    >
      ...
      <a-button
        ...
        data-catch="construction-log-create-btn"
      >
        + 填写日志
      </a-button>
    </div>
    ...
    <!-- 选择模板弹窗 -->
    <a-modal v-model:open="showTemplateModal" title="选择工作项模板" :footer="null">
...
async function loadRecords() {
  ...
  try {
    ...
    records.value = (res as LogRecord[]).filter(
      (r: LogRecord) => r.formTypeName === '施工日志' || r.formNo?.startsWith('LOG')
    )
  } catch {
