...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "D:/Taozhuowei/Project/BOYUAN OA/node_modules/ufo/dist/index.mjs";
...
import { u as useHead } from "./v3-p488jL4k.js";
...
import "D:/Taozhuowei/Project/BOYUAN OA/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-a87958a4><div class="fixed left-0 right-0 spotlight z-10" data-v-a87958a4></div><div class="max-w-520px text-center z-20" data-v-a87958a4><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-a87958a4>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-a87958a4>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-a87958a4>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a87958a4"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-KOU0--1Z.js.map
