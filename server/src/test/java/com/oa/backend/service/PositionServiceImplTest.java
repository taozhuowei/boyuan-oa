...
/** PositionServiceImpl 单元测试 覆盖：创建岗位、参数校验、默认值填充、不存在岗位的更新 */
...
class PositionServiceImplTest {
  ...
  void createPosition_explicitValues_override_defaults() {
    ...
    PositionUpsertRequest req =
        new PositionUpsertRequest(
            "施工岗",
            "LABOR",
            "worker",
            new BigDecimal("6000"),
  ...
  void updatePosition_deletedPosition_throwsException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> service.updatePosition(1L, emptyReqWithName("新名称")));
  }
  ...
  @Test
  @DisplayName(
      "deletePosition: already deleted treated as not found, throws ResponseStatusException")
  ...
  @Test
  @DisplayName(
      "listPositions: mock positionMapper.selectList returns [position1, position2]; assert result.size()==2; assert result.get(0).positionName() equals first position name")
  ...
  @Test
  @DisplayName(
      "listLevels: mock positionLevelMapper.selectList returns list of 2 PositionLevel; assert size==2")
  ...
  @Test
  @DisplayName(
      "listLevels: positionId not found (positionMapper.selectById returns null) throws IllegalArgumentException")
  ...
  @Test
  @DisplayName(
      "createLevel: success - mock positionMapper.selectById returns valid position; mock positionLevelMapper.insert returns 1; assert returned PositionLevelResponse has correct levelName")
  void createLevel_success_returnsCorrectLevelName() {
    ...
    PositionLevelUpsertRequest req =
        new PositionLevelUpsertRequest("高级工程师", 1, null, null, null, null);
  ...
  @Test
  @DisplayName(
      "createLevel: positionId not found - positionMapper.selectById returns null; throws IllegalArgumentException")
  ...
  @Test
  @DisplayName(
      "createLevel: blank levelName - req with null/blank name; throws IllegalArgumentException")
  void createLevel_blankLevelName_throwsException() {
    PositionLevelUpsertRequest reqWithNull =
        new PositionLevelUpsertRequest(null, 1, null, null, null, null);
    assertThrows(IllegalArgumentException.class, () -> service.createLevel(1L, reqWithNull));

    PositionLevelUpsertRequest reqWithBlank =
        new PositionLevelUpsertRequest("   ", 1, null, null, null, null);
  ...
  @Test
  @DisplayName(
      "updateLevel: levelId not found - positionLevelMapper.selectById returns null; throws IllegalArgumentException")
  void updateLevel_levelNotFound_throwsException() {
    when(positionLevelMapper.selectById(99L)).thenReturn(null);

    PositionLevelUpsertRequest req =
        new PositionLevelUpsertRequest("新名称", 1, null, null, null, null);
  ...
  @Test
  @DisplayName(
      "updateLevel: success - mock selectById returns valid PositionLevel; mock updateById returns 1; verify updateById called")
  void updateLevel_success_callsUpdateById() {
    ...
    PositionLevelUpsertRequest req =
        new PositionLevelUpsertRequest("新名称", 2, null, null, null, null);
  ...
  @Test
  @DisplayName(
      "deleteLevel: not found - positionLevelMapper.selectById returns null; throws ResponseStatusException")
