...
/** SetupService 单元测试 覆盖：初始化状态检查、系统初始化、恢复码管理、CEO密码重置 */
...
class SetupServiceTest {
  ...
  void initialize_success() {
    ...
    // Execute
    SetupService.SetupRequest request =
  ...
  void initialize_withCustomRoles() {
    ...
    List<SetupService.CustomRoleRequest> customRoles =
    ...
    Role customRole1 =
        roles.stream().filter(r -> "manager".equals(r.getRoleCode())).findFirst().orElse(null);
  ...
  void initialize_skipsInvalidCustomRoles() {
    ...
    java.util.List<SetupService.CustomRoleRequest> customRoles =
        java.util.Arrays.asList(
  ...
  void initialize_alreadyInitialized() {
    ...
    IllegalStateException ex =
        assertThrows(IllegalStateException.class, () -> setupService.initialize(request));
  ...
  void initialize_nullRequest() {
    ...
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> setupService.initialize(null));
  ...
  void initialize_shortPassword() {
    ...
    SetupService.SetupRequest request =
        new SetupService.SetupRequest(
            null, "CEO", "13800000001", "short", "HR", "13800000002", null, null, null, null, null);

    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> setupService.initialize(request));
  ...
  void verifyAndRotateRecoveryCode_nullCode() {
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> setupService.verifyAndRotateRecoveryCode(null));
  ...
  void verifyAndRotateRecoveryCode_blankCode() {
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> setupService.verifyAndRotateRecoveryCode("   "));
