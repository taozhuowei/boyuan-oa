...
class RetentionServiceTest {
    ...
    void startExportAndDelete_withFormRecordType_shouldCreateTask() {
        ...
        verify(exportTaskMapper).insert(argThat(task ->
                task.getDataTypes().equals("FORM_RECORD")
        ));
    }
    ...
    void startExportAndDelete_withOperationLogType_shouldCreateTask() {
        ...
        verify(exportTaskMapper).insert(argThat(task ->
                task.getDataTypes().equals("OPERATION_LOG")
        ));
    }
    ...
    void startExportAndDelete_withConstructionLogType_shouldCreateTask() {
        ...
        verify(exportTaskMapper).insert(argThat(task ->
                task.getDataTypes().equals("CONSTRUCTION_LOG")
        ));
    }
    ...
    void startExportAndDelete_withInjuryClaimType_shouldCreateTask() {
        ...
        verify(exportTaskMapper).insert(argThat(task ->
                task.getDataTypes().equals("INJURY_CLAIM")
        ));
    }
