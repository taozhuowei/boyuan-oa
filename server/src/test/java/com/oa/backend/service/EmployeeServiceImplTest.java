...
class EmployeeServiceImplTest {
    ...
    void updateAccountStatus_notFound_throwsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> service.updateAccountStatus(999L, "DISABLED"));
    }
    ...
    void applySalaryOverride_notFound_throwsException() {
        ...
        SalaryOverrideRequest req = new SalaryOverrideRequest(
            new BigDecimal("5000"), new BigDecimal("1000"), "备注"
        );
    ...
    @Test
    @DisplayName("applySalaryOverride：成功更新 baseSalaryOverride/performanceBaseOverride/salaryOverrideNote")
    void applySalaryOverride_success_updatesFields() {
        ...
        SalaryOverrideRequest req = new SalaryOverrideRequest(
            new BigDecimal("8000"), new BigDecimal("2000"), "绩效调整"
        );
