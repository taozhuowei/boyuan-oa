...
public class ExpenseController {
  ...
  public ResponseEntity<FormRecordResponse> submitExpense(
      @Valid @RequestBody ExpenseSubmitRequest request, Authentication authentication) {
  ...
  public ResponseEntity<ExpenseClaimResponse> getExpenseDetail(
      @PathVariable Long formId, Authentication authentication) {
    ...
    return new FormConfigResponse(
        ...
        java.util.Arrays.asList(
            new FormConfigResponse.FormField(
                ...
                null,
                java.util.Arrays.asList(
                    "TRAVEL", "MEAL", "ACCOMMODATION", "TRANSPORT", "OFFICE", "OTHER"),
                "请选择报销类型",
                1),
            new FormConfigResponse.FormField(
                "tripStartDate", "出差开始日期", "DATE", false, null, null, "请选择出差开始日期", 2),
            new FormConfigResponse.FormField(
                "tripEndDate", "出差结束日期", "DATE", false, null, null, "请选择出差结束日期", 3),
            new FormConfigResponse.FormField(
                "tripDestination", "出差目的地", "TEXT", false, null, null, "请输入出差目的地", 4),
            new FormConfigResponse.FormField(
                "tripPurpose", "出差事由", "TEXTAREA", false, null, null, "请输入出差事由", 5),
            new FormConfigResponse.FormField(
                "totalAmount", "报销总金额", "NUMBER", true, null, null, "请输入报销总金额", 6),
            new FormConfigResponse.FormField(
                "remark", "备注说明", "TEXTAREA", false, null, null, "请输入备注说明", 7)),
        java.util.Arrays.asList(
            new FormConfigResponse.FormAction(
                "submit",
                "提交申请",
                "primary",
            ...
            new FormConfigResponse.FormAction(
                ...
                "default",
                java.util.Arrays.asList(
                    "EMPLOYEE", "WORKER", "FINANCE", "PROJECT_MANAGER", "CEO"))),
        new FormConfigResponse.ApprovalFlow(
            "EXPENSE",
            java.util.Arrays.asList(
