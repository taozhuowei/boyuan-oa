...
public class PositionController {
  ...
  public ResponseEntity<PositionResponse> updatePosition(
      @PathVariable Long id, @RequestBody PositionUpsertRequest request) {
  ...
  public ResponseEntity<PositionLevelResponse> createLevel(
      @PathVariable Long id, @RequestBody PositionLevelUpsertRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED).body(positionService.createLevel(id, request));
  }
