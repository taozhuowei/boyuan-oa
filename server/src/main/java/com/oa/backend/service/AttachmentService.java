...
/**
 * 附件元数据持久化服务。
 * 职责：保存上传文件的元数据记录，以及解析当前用户身份。
 * 访问控制逻辑由 AttachmentAccessService 负责。
 */
@Service
...
public class AttachmentService {
     ...
     */
    public AttachmentMeta saveAttachmentMeta(String businessType, Long businessId,
                                             String fileName, String storagePath,
                                             String fileMd5, long fileSize,
