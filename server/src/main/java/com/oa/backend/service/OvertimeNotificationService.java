 ...
 * 加班通知服务类。
 *
 * <p>负责加班通知的创建、查询和员工响应操作，封装 OvertimeNotificationMapper、 OvertimeResponseMapper 和 EmployeeMapper
 * 的调用。 数据来源：overtime_notification 表、overtime_response 表。
 *
 * <p>注意：本服务与 NotificationService 相互独立——NotificationService 处理系统站内信， 本服务处理业务层加班通知及员工响应记录。
 */
@Service
