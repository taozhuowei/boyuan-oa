...
/** 操作日志服务 职责：封装操作日志（OperationLog）的分页查询与操作员姓名关联逻辑， 供 OperationLogController 调用，隔离控制器与 Mapper 细节。 */
@Service
...
public class OperationLogService {
  ...
  /**
   * 分页查询操作日志，支持按操作时间范围过滤，结果按操作时间倒序排列。 每条记录附带操作员姓名（通过 EmployeeMapper 关联查询）。
   *
