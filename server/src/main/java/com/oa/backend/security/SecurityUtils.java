...
public class SecurityUtils {
  ...
  private static final List<String> EMPLOYEE_ACCESS_ROLES =
      Arrays.asList(
          "ROLE_EMPLOYEE", "ROLE_FINANCE", "ROLE_PROJECT_MANAGER", "ROLE_CEO", "ROLE_WORKER");

  private static final List<String> FINANCE_ACCESS_ROLES =
      Arrays.asList("ROLE_FINANCE", "ROLE_CEO");

  private static final List<String> APPROVER_ROLES =
      Arrays.asList("ROLE_PROJECT_MANAGER", "ROLE_CEO");

  /**
   * 根据用户名获取员工 ID 查询 employee_no = username 的员工记录
   *
   ...
   */
  public static String getDisplayNameFromEmployeeId(
      Long employeeId, EmployeeMapper employeeMapper) {
  ...
  /**
   * 获取当前登录员工的 ID。 需要先通过 setEmployeeMapper 设置 EmployeeMapper。
   *
