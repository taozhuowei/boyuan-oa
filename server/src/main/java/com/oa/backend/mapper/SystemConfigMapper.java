...
public interface SystemConfigMapper extends BaseMapper<SystemConfig> {
     ...
     */
    @Insert("MERGE INTO system_config (config_key, config_value, description) " +
            "KEY (config_key) VALUES (#{key}, #{value}, #{description})")
    void setValue(@Param("key") String key, @Param("value") String value, @Param("description") String description);
